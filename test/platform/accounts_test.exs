defmodule Platform.AccountsTest do
  ...
  describe "players" do
    ...
    @valid_attrs %{score: "some score", username: "some username"}
    @update_attrs %{score: "some updated score", username: "some updated username"}
    ...
    test "create_player/1 with valid data creates a player" do
      ...
      assert player.score == "some score"
    ...
    test "update_player/2 with valid data updates the player" do
      ...
      assert player.score == "some updated score"
